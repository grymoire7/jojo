# lib/jojo/commands/branding/prompt.rb
module Jojo
  module Commands
    module Branding
      module Prompt
        def self.generate_prompt(job_description:, resume:, company_name:, seeker_name:, voice_and_tone:, research: nil, job_details: nil)
          <<~PROMPT
