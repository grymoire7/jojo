...
module Jojo
  class Application
    ...
    def resume_pdf_path = File.join(website_path, "resume.pdf")
    def cover_letter_pdf_path = File.join(website_path, "cover_letter.pdf")
    def resume_html_path = File.join(website_path, "resume.html")
    def cover_letter_html_path = File.join(website_path, "cover_letter.html")
